...
SMPS_SoundIndex:
	...
	sfxdef $0,1,0,0,SfxFlicky,sfx_Flicky
	sfxdef $0,0,0,0,SfxFlickyGrab,sfx_FlickyGrab
	sfxdef $0,0,0,0,SfxSpindash,sfx_Spindash
	sfxdef $0,0,0,0,SfxSpikeMove,sfx_SpikeMove

	sfxdef $0,0,0,0,SfxS1A0,sfx_S1Jump
	sfxdef $3,0,0,0,SfxS1A1,sfx_S1Lamppost
	sfxdef $3,0,0,0,SfxS1A2,sfx_S1UnkA2
	sfxdef $3,0,0,0,SfxS1A3,sfx_S1Death
	sfxdef $3,0,0,0,SfxS1A4,sfx_S1Skid
	sfxdef $5,0,0,0,SfxS1A5,sfx_S1UnkA5
	sfxdef $3,0,0,0,SfxS1A6,sfx_S1HitSpikes
	sfxdef $3,0,0,0,SfxS1A7,sfx_S1Push
	sfxdef $3,0,0,0,SfxS1A8,sfx_S1SSGoal
	sfxdef $3,0,0,0,SfxS1A9,sfx_S1SSItem
	sfxdef $2,0,0,0,SfxS1AA,sfx_S1Splash
	sfxdef $3,0,0,0,SfxS1AB,sfx_S1UnkAB
	sfxdef $3,0,0,0,SfxS1AC,sfx_S1HitBoss
	sfxdef $3,0,0,1,SfxS1AD,sfx_S1Bubble
	sfxdef $1,0,0,0,SfxS1AE,sfx_S1Fireball
	sfxdef $3,0,0,0,SfxS1AF,sfx_S1Shield
	sfxdef $3,0,0,0,SfxS1B0,sfx_S1Saw
	sfxdef $1,0,0,0,SfxS1B1,sfx_S1Electric
	sfxdef $3,0,0,1,SfxS1B2,sfx_S1Drown
	sfxdef $1,0,0,0,SfxS1B3,sfx_S1Flamethrower
	sfxdef $3,0,0,0,SfxS1B4,sfx_S1Bumper
	sfxdef $3,0,0,0,SfxS1B5,sfx_S1Ring
	sfxdef $3,0,0,0,SfxS1B6,sfx_S1SpikesMove
	sfxdef $3,0,0,0,SfxS1B7,sfx_S1Rumbling
	sfxdef $3,0,0,0,SfxS1B8,sfx_S1UnkB8
	sfxdef $3,0,0,0,SfxS1B9,sfx_S1Collapse
	sfxdef $3,0,0,0,SfxS1BA,sfx_S1SSGlass
	sfxdef $3,0,0,0,SfxS1BB,sfx_S1Door
	sfxdef $3,0,0,0,SfxS1BC,sfx_S1Teleport
	sfxdef $3,0,0,0,SfxS1BD,sfx_S1ChainStomp
	sfxdef $3,0,0,0,SfxS1BE,sfx_S1Roll
	sfxdef $F,0,0,0,SfxS1BF,sfx_S1Continue
	sfxdef $1,0,0,0,SfxS1C0,sfx_S1Basaran
	sfxdef $3,0,0,0,SfxS1C1,sfx_S1BreakItem
	sfxdef $3,0,0,1,SfxS1C2,sfx_S1Warning
	sfxdef $3,0,0,0,SfxS1C3,sfx_S1GiantRing
	sfxdef $3,0,0,0,SfxS1C4,sfx_S1Bomb
	sfxdef $3,0,0,0,SfxS1C5,sfx_S1Cash
	sfxdef $3,0,0,0,SfxS1C6,sfx_S1RingLoss
	sfxdef $3,0,0,0,SfxS1C7,sfx_S1ChainRise
	sfxdef $3,0,0,0,SfxS1C8,sfx_S1Burning
	sfxdef $3,0,0,0,SfxS1C9,sfx_S1Bonus
	sfxdef $3,0,0,0,SfxS1CA,sfx_S1EnterSS
	sfxdef $3,0,0,0,SfxS1CB,sfx_S1WallSmash
	sfxdef $3,0,0,0,SfxS1CC,sfx_S1Spring
	sfxdef $3,0,0,0,SfxS1CD,sfx_S1Switch
	sfxdef $3,0,0,0,SfxS1CE,sfx_S1RingLeft
	sfxdef $3,0,0,0,SfxS1CF,sfx_S1Signpost
	sfxdef $0,0,0,0,BfxS1D0,bfx_S1Waterfall
...
;	db	6Fh
	sfxdef $0,0,0,0,SfxS2A0,sfx_S2A0
	sfxdef $0,0,0,0,SfxS2A1,sfx_S2A1
	sfxdef $0,0,0,0,SfxS2A2,sfx_S2A2
	sfxdef $0,0,0,0,SfxS2A3,sfx_S2A3
	sfxdef $0,0,0,0,SfxS2A4,sfx_S2A4
	sfxdef $0,0,0,0,SfxS2A5,sfx_S2A5
	sfxdef $0,0,0,0,SfxS2A6,sfx_S2A6
	sfxdef $0,0,0,0,SfxS2A7,sfx_S2A7
	sfxdef $0,0,0,0,SfxS2A8,sfx_S2A8
	sfxdef $0,0,0,0,SfxS2A9,sfx_S2A9
	sfxdef $0,0,0,0,SfxS2AA,sfx_S2AA
	sfxdef $0,0,0,0,SfxS2AB,sfx_S2AB
	sfxdef $0,0,0,0,SfxS2AC,sfx_S2AC
	sfxdef $0,0,0,0,SfxS2AD,sfx_S2AD
	sfxdef $0,0,0,0,SfxS2AE,sfx_S2AE
	sfxdef $0,0,0,0,SfxS2AF,sfx_S2AF
	sfxdef $0,0,0,0,SfxS2B0,sfx_S2B0
	sfxdef $0,0,0,0,SfxS2B1,sfx_S2B1
	sfxdef $0,0,0,0,SfxS2B2,sfx_S2B2
	sfxdef $0,0,0,0,SfxS2B3,sfx_S2B3
	sfxdef $0,0,0,0,SfxS2B4,sfx_S2B4
	sfxdef $0,0,0,0,SfxS2B5,sfx_S2B5
	sfxdef $0,0,0,0,SfxS2B6,sfx_S2B6
	sfxdef $0,0,0,0,SfxS2B7,sfx_S2B7
	sfxdef $0,0,0,0,SfxS2B8,sfx_S2B8
	sfxdef $0,0,0,0,SfxS2B9,sfx_S2B9
	sfxdef $0,0,0,0,SfxS2BA,sfx_S2BA
	sfxdef $0,0,0,0,SfxS2BB,sfx_S2BB
	sfxdef $0,0,0,0,SfxS2BC,sfx_S2BC
	sfxdef $0,0,0,0,SfxS2BD,sfx_S2BD
	sfxdef $0,0,0,0,SfxS2BE,sfx_S2BE
	sfxdef $0,0,0,0,SfxS2BF,sfx_S2BF
	sfxdef $0,0,0,0,SfxS2C0,sfx_S2C0
	sfxdef $0,0,0,0,SfxS2C1,sfx_S2C1
	sfxdef $0,0,0,0,SfxS2C2,sfx_S2C2
	sfxdef $0,0,0,0,SfxS2C3,sfx_S2C3
	sfxdef $0,0,0,0,SfxS2C4,sfx_S2C4
	sfxdef $0,0,0,0,SfxS2C5,sfx_S2C5
	sfxdef $0,0,0,0,SfxS2C6,sfx_S2C6
	sfxdef $0,0,0,0,SfxS2C7,sfx_S2C7
	sfxdef $0,0,0,0,SfxS2C8,sfx_S2C8
	sfxdef $0,0,0,0,SfxS2C9,sfx_S2C9
	sfxdef $0,0,0,0,SfxS2CA,sfx_S2CA
	sfxdef $0,0,0,0,SfxS2CB,sfx_S2CB
	sfxdef $0,0,0,0,SfxS2CC,sfx_S2CC
	sfxdef $0,0,0,0,SfxS2CD,sfx_S2CD
	sfxdef $0,0,0,0,SfxS2CE,sfx_S2CE
	sfxdef $0,0,0,0,SfxS2CF,sfx_S2CF
	sfxdef $0,0,0,0,SfxS2D0,sfx_S2D0
	sfxdef $0,0,0,0,SfxS2D1,sfx_S2D1
	sfxdef $0,0,0,0,SfxS2D2,sfx_S2D2
	sfxdef $0,0,0,0,SfxS2D3,sfx_S2D3
	sfxdef $0,0,0,0,SfxS2D4,sfx_S2D4
	sfxdef $0,0,0,0,SfxS2D5,sfx_S2D5
	sfxdef $0,0,0,0,SfxS2D6,sfx_S2D6
	sfxdef $0,0,0,0,SfxS2D7,sfx_S2D7
	sfxdef $0,0,0,0,SfxS2D8,sfx_S2D8
	sfxdef $0,0,0,0,SfxS2D9,sfx_S2D9
	sfxdef $0,0,0,0,SfxS2DA,sfx_S2DA
	sfxdef $0,0,0,0,SfxS2DB,sfx_S2DB
	sfxdef $0,0,0,0,SfxS2DC,sfx_S2DC
	sfxdef $0,0,0,0,SfxS2DD,sfx_S2DD
	sfxdef $0,0,0,0,SfxS2DE,sfx_S2DE
	sfxdef $0,0,0,0,SfxS2DF,sfx_S2DF
	sfxdef $0,0,0,0,SfxS2E0,sfx_S2E0
	sfxdef $0,0,0,0,SfxS2E1,sfx_S2E1
	sfxdef $0,0,0,0,SfxS2E2,sfx_S2E2
	sfxdef $0,0,0,0,SfxS2E3,sfx_S2E3
	sfxdef $0,0,0,0,SfxS2E4,sfx_S2E4
	sfxdef $0,0,0,0,SfxS2E5,sfx_S2E5
	sfxdef $0,0,0,0,SfxS2E6,sfx_S2E6
	sfxdef $0,0,0,0,SfxS2E7,sfx_S2E7
	sfxdef $0,0,0,0,SfxS2E8,sfx_S2E8
	sfxdef $0,0,0,0,SfxS2E9,sfx_S2E9
	sfxdef $0,0,0,0,SfxS2EA,sfx_S2EA
	sfxdef $0,0,0,0,SfxS2EB,sfx_S2EB
	sfxdef $0,0,0,0,SfxS2EC,sfx_S2EC
	sfxdef $0,0,0,0,SfxS2ED,sfx_S2ED
	sfxdef $0,0,0,0,SfxS2EE,sfx_S2EE
	sfxdef $0,0,0,0,SfxS2EF,sfx_S2EF
	sfxdef $0,0,0,0,SfxS2F0,sfx_S2F0

	sfxdef $0,0,0,0,SfxS2BD0,sfx_S2BD0
	sfxdef $0,0,0,0,SfxS2BD1,sfx_S2BD1
	sfxdef $0,0,0,0,SfxS2BD2,sfx_S2BD2
	sfxdef $0,0,0,0,SfxS2BD3,sfx_S2BD3
	sfxdef $0,0,0,0,SfxS2BD4,sfx_S2BD4
	sfxdef $0,0,0,0,SfxS2BD5,sfx_S2BD5
	sfxdef $0,0,0,0,SfxS2BD6,sfx_S2BD6
	sfxdef $0,0,0,0,SfxS2BD7,sfx_S2BD7
	sfxdef $0,0,0,0,SfxS2BD8,sfx_S2BD8
	sfxdef $0,0,0,0,SfxS2BD9,sfx_S2BD9
	sfxdef $0,0,0,0,SfxS2BDA,sfx_S2BDA
	sfxdef $0,0,0,0,SfxS2BDB,sfx_S2BDB
	sfxdef $0,0,0,0,SfxS2BDC,sfx_S2BDC
	sfxdef $0,0,0,0,SfxS2BDD,sfx_S2BDD
	sfxdef $0,0,0,0,SfxS2BDE,sfx_S2BDE
	sfxdef $0,0,0,0,SfxS2BDF,sfx_S2BDF
	sfxdef $0,0,0,0,SfxS2BE0,sfx_S2BE0
