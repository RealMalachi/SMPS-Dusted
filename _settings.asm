...
__smpsDataVer		equ 2		; if these don't match between the driver and sound data, it complains
...
__smpsPanEnv		equ 0		; (TODO) 1 enables panning envelopes
__smpsFM3Multi		equ 0		; (TODO) 1 enables FM3 multifrequency mode
__smpsDrum		equ 1		; 1 enables YMPCM notes and FM/PSG drums
