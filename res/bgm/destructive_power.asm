DestructivePower_Header:
	...
	smpsHeaderChan      $05, $03, $01
	smpsHeaderTempo     $02, $0000
...
;	smpsHeaderFM        DestructivePower_FM5, $09, $10
	...
	smpsHeaderPSG       DestructivePower_PSG1, $00, $20, $00, cTone_02
	smpsHeaderPSG       DestructivePower_PSG2, $00, $38, $00, cTone_02
...
DestructivePower_DAC:
	dc.b	pCrash, $12, pKick, pSnare, $0C
	dc.b	pKick, $06, $0C, $12, pSnare, $0C
	smpsLoop            $00, $07, DestructivePower_DAC
	dc.b	pCrash, $12, pKick, pSnare, $0C
	dc.b	pKick, $06, $0C, pTomHi, $06, pTomMid, pTomLo, pSnare, $0C
	smpsJump            DestructivePower_DAC
