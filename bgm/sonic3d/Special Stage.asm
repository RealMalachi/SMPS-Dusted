Snd_S3DSpecial_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoice     Snd_S3DSpecial_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $10

	smpsHeaderDAC       Snd_S3DSpecial_DAC
	smpsHeaderFM        Snd_S3DSpecial_FM1,	$FF, $10
	smpsHeaderFM        Snd_S3DSpecial_FM2,	$FF, $16
	smpsHeaderFM        Snd_S3DSpecial_FM3,	$FF, $12
	smpsHeaderFM        Snd_S3DSpecial_FM4,	$FF, $12
	smpsHeaderFM        Snd_S3DSpecial_FM5,	$FF, $14
	smpsHeaderPSG       Snd_S3DSpecial_PSG1,	$00, $06, $00, sTone_06
	smpsHeaderPSG       Snd_S3DSpecial_PSG2,	$00, $07, $00, sTone_04
	smpsHeaderPSG       Snd_S3DSpecial_PSG3,	$23, $01, $00, sTone_03
...
Snd_S3DSpecial_Jump05:
	...
	smpsJump            Snd_S3DSpecial_Jump05
...
Snd_S3DSpecial_Jump04:
	...
	smpsAlterPitch      $0C
	smpsFMAlterVol      $FD
	smpsJump            Snd_S3DSpecial_Jump04
...
Snd_S3DSpecial_Jump03:
	...
	smpsJump            Snd_S3DSpecial_Jump03
...
Snd_S3DSpecial_Jump02:
	...
	smpsJump            Snd_S3DSpecial_Jump02
...
Snd_S3DSpecial_Jump01:
	...
	smpsAlterPitch      $0C
	smpsFMAlterVol      $07
	smpsJump            Snd_S3DSpecial_Jump01
...
Snd_S3DSpecial_Loop00:
	smpsCall            Snd_S3DSpecial_Call00
	smpsCall            Snd_S3DSpecial_Call01
	smpsCall            Snd_S3DSpecial_Call00
	smpsCall            Snd_S3DSpecial_Call02
	smpsCall            Snd_S3DSpecial_Call00
	smpsCall            Snd_S3DSpecial_Call01
	smpsCall            Snd_S3DSpecial_Call03
	smpsCall            Snd_S3DSpecial_Call04
	smpsLoop            $01, $02, Snd_S3DSpecial_Loop00

Snd_S3DSpecial_Loop01:
	smpsCall            Snd_S3DSpecial_Call05
	smpsCall            Snd_S3DSpecial_Call06
	smpsCall            Snd_S3DSpecial_Call05
	smpsCall            Snd_S3DSpecial_Call07
	smpsLoop            $01, $02, Snd_S3DSpecial_Loop01

Snd_S3DSpecial_Loop02:
	smpsCall            Snd_S3DSpecial_Call08
	smpsLoop            $01, $02, Snd_S3DSpecial_Loop02

Snd_S3DSpecial_Loop03:
	smpsCall            Snd_S3DSpecial_Call09
	smpsLoop            $01, $03, Snd_S3DSpecial_Loop03
	smpsJump            Snd_S3DSpecial_Loop00

Snd_S3DSpecial_Call00:
	smpsPSGvoice        sTone_12
	dc.b	(nMaxPSG2-$23)&$FF, $18

Snd_S3DSpecial_Loop05:
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, Snd_S3DSpecial_Loop05
	smpsReturn

Snd_S3DSpecial_Call01:
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $04, Snd_S3DSpecial_Call01
	smpsReturn

Snd_S3DSpecial_Call02:
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $02, Snd_S3DSpecial_Call02
	smpsPSGvoice        sTone_12
	dc.b	$30
	smpsReturn

Snd_S3DSpecial_Call03:
	smpsPSGvoice        sTone_12
	dc.b	(nMaxPSG2-$23)&$FF, $18
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $02, Snd_S3DSpecial_Call03
	smpsReturn

Snd_S3DSpecial_Call04:
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
	...
	dc.b	$06
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, Snd_S3DSpecial_Call04
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
...
Snd_S3DSpecial_Call05:
	smpsPSGvoice        sTone_12
	dc.b	$18

Snd_S3DSpecial_Loop04:
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
	...
	dc.b	$06
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, Snd_S3DSpecial_Loop04
	smpsReturn

Snd_S3DSpecial_Call06:
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
	...
	dc.b	$06
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, Snd_S3DSpecial_Call06
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
...
Snd_S3DSpecial_Jump00:
	...
	smpsJump            Snd_S3DSpecial_Jump00

Snd_S3DSpecial_Voices:
;	Voice $00
;	$3C
