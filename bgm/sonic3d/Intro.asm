Snd_S3DIntro_Header:
	...
	smpsHeaderVoice     Snd_S3DIntro_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $04

	smpsHeaderDAC       Snd_S3DIntro_DAC
	...
	smpsHeaderFM        Snd_S3DIntro_FM1,	$14, $0B
	smpsHeaderFM        Snd_S3DIntro_FM2,	$00, $03
	smpsHeaderFM        Snd_S3DIntro_FM3,	$00, $05
	smpsHeaderFM        Snd_S3DIntro_FM4,	$FC, $18
	smpsHeaderFM        Snd_S3DIntro_FM5,	$FC, $09
	smpsHeaderPSG       Snd_S3DIntro_PSG1,	$FC, $02, $00, $00
	smpsHeaderPSG       Snd_S3DIntro_PSG2,	$FC, $04, $00, $00
	smpsHeaderPSG       Snd_S3DIntro_PSG3,	$23, $01, $00, $00

; FM1 Data
Snd_S3DIntro_FM1:
	smpsSetvoice        $00
	dc.b	nRst, $60, nRst
	smpsCall            Snd_S3DIntro_Call00
	smpsCall            Snd_S3DIntro_Call00
	smpsCall            Snd_S3DIntro_Call01
	dc.b	nB0, nRst, nB1, nB1, nC1, nRst, nC2, nC2, nD1, nE1, nD1, nC1
	dc.b	nB0, nA0, nG0, smpsNoAttack, nG0
	smpsCall            Snd_S3DIntro_Call02
	smpsCall            Snd_S3DIntro_Call03
	smpsCall            Snd_S3DIntro_Call00
	smpsCall            Snd_S3DIntro_Call00
	smpsStop
...
Snd_S3DIntro_Loop02:
	...
	smpsFMAlterVol      $FF
	smpsLoop            $00, $1F, Snd_S3DIntro_Loop02
...
Snd_S3DIntro_Loop01:
	dc.b	smpsNoAttack, nFs6
	smpsFMAlterVol      $FF
	smpsLoop            $00, $1F, Snd_S3DIntro_Loop01
	smpsPan             panCenter, $00
	smpsSetvoice        $05
	smpsAlterNote       $02
	smpsAlterPitch      $FC
...
Snd_S3DIntro_Loop05:
	...
	smpsLoop            $00, $02, Snd_S3DIntro_Loop05

Snd_S3DIntro_Loop06:
	dc.b	nB2, nF3, nB2, nF3, nB2, nF3, nB2, nF3
	smpsLoop            $00, $02, Snd_S3DIntro_Loop06
...
Snd_S3DIntro_Loop04:
	...
	smpsLoop            $00, $02, Snd_S3DIntro_Loop04
...
Snd_S3DIntro_Loop03:
	smpsCall            Snd_S3DIntro_Call04
	smpsLoop            $00, $0A, Snd_S3DIntro_Loop03
	smpsStop
