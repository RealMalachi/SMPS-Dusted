...
; "mdz80"  | Z80 driver + 68K API (unimplemented)
; "fuckFM" | 68K driver with FM disabled
; "sys14"  | 68K driver for 2xYM2203 System 14s (unimplemented)
; "pico"   | 68K driver for Sega Pico (unimplemented)
; "copera" | 68K driver for Yamaha Copera (unimplemented)
; TOOD: MegaPico for 68K and Z80? https://youtu.be/xWsJlW3UeXM
; ---------------------------------------------------------------------------
